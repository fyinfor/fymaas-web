export default {
  ...
  'orgs.form.displayName': 'Organization name',
  'orgs.form.displayName.placeholder': 'Enter an organization name',
  'orgs.form.name': 'Organization key',
  'orgs.form.name.placeholder': 'Enter an organization key',
  'orgs.form.name.rule':
    'Must start with a lowercase letter; only lowercase letters, numbers, and hyphens',
  'orgs.form.name.readonly': 'The key cannot be changed after creation',
