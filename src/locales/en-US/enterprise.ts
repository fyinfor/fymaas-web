export default {
  ...
  'quotas.noresult.subTitle': 'Add a policy to cap tokens or request rate for a tenant or key.',
  ...
  'orgs.noresult.subTitle': 'Create an organization to isolate tenants and members.'
};
