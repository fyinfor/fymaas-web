export default {
  ...
  'kvCache.providerSelect.title': 'Select Cache Engine',
  'kvCache.provider.source.builtin': 'Built-in',
  'kvCache.provider.source.community': 'Community',
  'kvCache.provider.source.partner': 'fymaas Certified Partner',
