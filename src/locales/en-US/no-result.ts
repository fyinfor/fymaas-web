export default {
  ...
  'noresult.providers.title': 'No Model Types',
  'noresult.providers.subTitle': 'No model types have been added yet.',
  'noresult.providers.nofound': 'No matching model types found.',
