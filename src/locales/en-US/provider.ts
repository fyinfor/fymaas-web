export default {
  'providers.title': 'Model Types',
  'providers.button.add': 'Add Model Type',
  'providers.button.clone': 'Clone Model Type',
  'providers.table.providerName': 'Model Type',
  ...
  'providers.form.target.placeholder': 'model type / model',
  ...
  'providers.form.claudeCustomUrl.tips':
    'When set, this model type serves the Anthropic protocol (/v1/messages) only, and OpenAI-style requests are not converted. Leave it empty to use api.anthropic.com through the OpenAI protocol.',
