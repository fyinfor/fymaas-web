export default {
  ...
  'orgs.form.displayName': '組織名',
  'orgs.form.displayName.placeholder': '組織名を入力',
  'orgs.form.name': '組織識別子',
  'orgs.form.name.placeholder': '組織識別子を入力',
  'orgs.form.name.rule': '先頭は小文字、小文字・数字・ハイフンのみ',
  'orgs.form.name.readonly': '識別子は作成後に変更できません',
  'orgs.members': 'メンバー',
