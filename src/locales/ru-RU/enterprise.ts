export default {
  ...
  'orgs.form.displayName': 'Название организации',
  'orgs.form.displayName.placeholder': 'Введите название организации',
  'orgs.form.name': 'Идентификатор',
  'orgs.form.name.placeholder': 'Введите идентификатор',
  'orgs.form.name.rule':
    'Начинается с строчной буквы, только строчные буквы, цифры и дефисы',
  'orgs.form.name.readonly': 'Идентификатор нельзя изменить после создания',
