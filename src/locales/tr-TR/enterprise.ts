export default {
  ...
  'orgs.form.displayName': 'Organizasyon adı',
  'orgs.form.displayName.placeholder': 'Organizasyon adı girin',
  'orgs.form.name': 'Organizasyon anahtarı',
  'orgs.form.name.placeholder': 'Organizasyon anahtarı girin',
  'orgs.form.name.rule':
    'Küçük harfle başlamalı; yalnızca küçük harf, rakam ve tire',
  'orgs.form.name.readonly': 'Anahtar oluşturulduktan sonra değiştirilemez',
  'orgs.members': 'Üyeler',
