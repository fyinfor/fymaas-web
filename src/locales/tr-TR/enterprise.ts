export default {
  ...
  'quotas.noresult.subTitle': 'Bir kiracı veya anahtar için jeton ya da istek hızı sınırı ekleyin.',
  ...
  'orgs.noresult.subTitle': 'Kiracıları ve üyeleri ayırmak için bir organizasyon oluşturun.'
};
