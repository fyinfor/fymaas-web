export default {
  ...
  'routes.table.endpoint': 'Endpoint',
  'routes.status.ready': 'Hazır',
  'routes.status.degraded': 'Düşük performans',
  'routes.status.inactive': 'Pasif',
  'routes.table.endpoint': 'Endpoint',
  'routes.status.ready': 'Hazır',
  'routes.status.degraded': 'Bozulmuş',
  'routes.status.inactive': 'Pasif',
