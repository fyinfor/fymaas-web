export default {
  ...
  'users.version.islatest': 'Tokease {version} en güncel sürümdür',
  'users.version.update': 'Tokease {version} kullanılabilir',
  ...
  'users.login.getInitialPassword':
    'Başlangıç yönetici şifresini almak için fymaas Sunucunuzda aşağıdaki komutu çalıştırın.'
};
