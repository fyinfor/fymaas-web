export default {
  ...
  'models.form.partialoffload.tips':
    '启用 CPU 卸载后，GPU 不足时 fymaas 会自动使用 CPU 内存。请确保推理后端已正确配置为混合 CPU+GPU 或纯 CPU 推理。',
  ...
  'model.form.ollamatips':
    '提示：以下为 fymaas 预设的 Ollama 模型，请选择你想要的模型或者直接在右侧表单 【{name}】 输入框中输入你要部署的模型。',
  'models.sort.name': '名称',
  'models.sort.size': '大小',
  ...
  'models.form.backendVersion.tips':
    '固定以使用期望的 {backend} 版本 {version}，在线环境会自动创建虚拟环境安装对应版本的 {backend}。在 fymaas 升级后也将保持固定的后端版本。{link}',
  ...
  'models.status.running': '运行中',
  'models.status.deploying': '部署中',
  'models.status.stopped': '已停止',
  ...
  'models.table.apiAccessInfo.examples': '请求示例',
  'models.table.apiAccessInfo.schemaTitle': '返回数据结构说明',
  'models.table.apiAccessInfo.schema.name': '参数',
  'models.table.apiAccessInfo.schema.type': '类型',
  'models.table.apiAccessInfo.schema.example': '示例值',
  'models.table.apiAccessInfo.schema.desc': '说明',
  'models.table.apiAccessInfo.schema.id': '本次补全请求的唯一标识',
  'models.table.apiAccessInfo.schema.object': '返回对象类型',
  'models.table.apiAccessInfo.schema.created': '创建时间的 Unix 时间戳',
  'models.table.apiAccessInfo.schema.model': '实际使用的模型名称',
  'models.table.apiAccessInfo.schema.choices': '模型生成的候选结果列表',
  'models.table.apiAccessInfo.schema.usage': '本次请求的 token 用量',
  'models.table.apiAccessInfo.schema.data': '返回的向量或结果列表',
  ...
  'models.form.modelfile.notfound':
    '你指定的模型文件路径在 fymaas Server 节点上不存在。建议在 fymaas Server 节点和 fymaas 节点上使用相同的模型文件路径，这有助于 fymaas 做出更优的调度与决策。',
  ...
  'models.catalog.source.official':
    '在随本版本打包的内置模型库之上，跟随 fymaas 发布的官方模型库。'
};
