export default {
  ...
  'resources.table.allocation': '分配',
  'resources.gpu.status.available': '可用',
  'resources.gpu.status.allocated': '已占用',
  ...
  'resources.worker.driver.install':
    '在安装 fymaas 之前，请安装<a href="https://docs.gpustack.ai/latest/installation/installation-requirements/" target="_blank">所需的驱动程序和库</a>。',
  ...
  'resources.register.install.title': '在 {os} 上安装 fymaas',
  ...
  'resoureces.worker.upgrade.tips': '请升级到与 fymaas Server 版本一致。',
