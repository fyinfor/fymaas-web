export default {
  ...
  'usage.tabs.users': '用户',
  'usage.noresult.nofound': '未找到匹配的用量记录',
  'usage.noresult.models.title': '暂无模型用量',
  'usage.noresult.models.subTitle': '所选时间范围内没有模型调用。',
  'usage.noresult.users.title': '暂无用户用量',
  'usage.noresult.users.subTitle': '所选时间范围内没有用户调用。',
  'usage.noresult.apikeys.title': '暂无 API 密钥用量',
  'usage.noresult.apikeys.subTitle': '所选时间范围内没有 API 密钥调用。',
  'usage.noresult.instances.title': '暂无 GPU 实例用量',
  'usage.noresult.instances.subTitle': '所选时间范围内没有 GPU 实例用量。',
  'usage.noresult.storage.title': '暂无存储用量',
  'usage.noresult.storage.subTitle': '所选时间范围内没有存储用量。',
  'usage.noresult.events.title': '暂无资源事件',
  'usage.noresult.events.subTitle': '所选时间范围内没有资源生命周期事件。',
